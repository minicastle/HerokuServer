  ...
  fieldNames.forEach(fieldName => {
    ...
    if (builderNames.includes(fieldName)) {
      ...
      if (areAllRemainingFieldsNullable(fieldName, builderNames, fields)) {
        args.push(`${bindingIdentifierName}${isNullable(field) ? "?:" : ":"} ${typeAnnotation}`);
      } else {
        args.push(`${bindingIdentifierName}: ${typeAnnotation}${isNullable(field) ? " | undefined" : ""}`);
      }
    }
  });
  return args;
...
`;
  ...
  Object.keys(definitions.BUILDER_KEYS).forEach(type => {
    ...
    output += `${formatedBuilderNameLocal === formatedBuilderName ? "export " : ""}function ${formatedBuilderNameLocal}(${defArgs.join(", ")}): t.${type} { return builder.apply("${type}", arguments); }\n`;
